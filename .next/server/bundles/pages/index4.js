...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("h1", null, "Test");
    }
  }], [{
    key: "getInitialProps",
    value: function () {
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return __WEBPACK_IMPORTED_MODULE_3_isomorphic_unfetch___default()(__WEBPACK_IMPORTED_MODULE_2__config__["a" /* config */].api.restUrl).then(function (r) {
                  return r.json();
                });
