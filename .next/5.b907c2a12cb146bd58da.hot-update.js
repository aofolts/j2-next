            ...
            return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 6:
                    site = _context.sent;
                    console.log("".concat(__WEBPACK_IMPORTED_MODULE_3__config__["a" /* config */].api.wpRestUrl, "/js/v1/menu/2")); // Menu Data

                    _context.next = 10;
                    return __WEBPACK_IMPORTED_MODULE_2_isomorphic_unfetch___default()("".concat(__WEBPACK_IMPORTED_MODULE_3__config__["a" /* config */].api.wpRestUrl, "/js/v1/menu/2"));
...
//# sourceMappingURL=5.b907c2a12cb146bd58da.hot-update.js.map